...
import com.alibaba.otter.canal.parser.SimpleDdlParser.DdlResult;
import com.alibaba.otter.canal.parser.TableMeta.FieldMeta;
...
public class LogEventConvert extends AbstractCanalLifeCycle implements BinlogParser<LogEvent> {
    ...
    private volatile com.alibaba.otter.canal.filter.aviater.AviaterRegexFilter nameFilter;                                                          // 运行时引用可能会有变化，比如规则发生变化时
    ...
    public void setNameFilter(com.alibaba.otter.canal.filter.aviater.AviaterRegexFilter nameFilter) {
